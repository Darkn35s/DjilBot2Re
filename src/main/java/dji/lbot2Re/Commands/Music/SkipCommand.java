...
*/
   ...
   */
    ...
    /*!
    Обработчик команды,принимает объект типа event удаляет текущий трек из очереди и запускает следующий если есть
    ...
    */
    ...
    public void handle(List<String> args, MessageReceivedEvent event) {
        ...
        event.getMessage().replyEmbeds(BotUtils.CommonMessage("Пропуск"+player.getPlayingTrack().getInfo().title,event.getGuild())).queue();
        scheduler.nextTrack();
